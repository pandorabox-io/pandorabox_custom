...
minetest.register_on_joinplayer(function(player)
  ...
  if entry and minetest.check_password_entry(playername, entry.password, default_pw) then
    ...
    minetest.chat_send_player(
      playername,
      minetest.colorize("#ff0000", "WARNING: You are using the default password! Please change it for your own safety! (press the escape-button and click on 'change password')")
    )
  end
end)
